...
namespace xp
{
    ...
    public:
        ...
        xshared_library(xshared_library &&other) noexcept;
        xshared_library &operator=(xshared_library &&other) noexcept;

        xshared_library(std::filesystem::path path);
        ~xshared_library();
    ...
    inline xshared_library::xshared_library(xshared_library &&other) noexcept
    {
        m_handle = other.m_handle;
        other.m_handle = nullptr;
    }

    inline xshared_library &xshared_library::operator=(xshared_library &&other) noexcept
    {
        m_handle = other.m_handle;
        other.m_handle = nullptr;
        return *this;
    ...
    inline xshared_library::xshared_library(std::filesystem::path path)
        : m_handle(nullptr)
    {
    ...
    inline xshared_library::~xshared_library()
    {
        if (m_handle)
        {
            dlclose(m_handle);
